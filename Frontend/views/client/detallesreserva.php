            ...
            <div class="ticket-details">
                <?php if (isset($ticket) && $ticket && is_array($ticket)): ?>
                    <div class="detail-row">
                        ...
                        <strong style="color:#39ff14;">#<?php echo str_pad($ticket['id_reserva'], 6, '0', STR_PAD_LEFT); ?></strong>
                    </div>
                    <div class="detail-row">
                        <span>Evento</span>
                ...
                <?php else: ?>
                    <div style="background: rgba(255,0,0,0.1); border: 1px solid red; padding: 15px; border-radius: 5px; text-align: left;">
                        <h4 style="color: #ff5555; margin-bottom: 5px;">Error de Visualización</h4>
                        <p style="font-size: 0.9rem; color: #ddd;">La reserva se guardó, pero no pudimos recuperar el ticket.</p>
                        <hr style="border-color: rgba(255,255,255,0.1); margin: 10px 0;">
                        <small style="color: #aaa;">ID Buscado: <strong><?php echo isset($_GET['id']) ? $_GET['id'] : 'Ninguno'; ?></strong></small>
                        <br>
                        <small style="color: #aaa;">Posible Causa: Integridad de base de datos (Usuario/Sede faltante).</small>
                    </div>
                <?php endif; ?>
            </div>
