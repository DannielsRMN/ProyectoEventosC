...
<head>
    <meta charset="UTF-8">
    <title>Crear Sede - EventosC</title>
    ...
    <div class="form-wrapper">
        <div class="form-container">
            <div class="form-header">
                <h1 class="form-title">🏢 Nueva Sede</h1>
            </div>

            <div class="form-card">
                <form method="POST" action="index.php?view=guardar_sede">
                    <div class="form-group">
                        <label class="form-label" for="nombre">Nombre de la Sede <span class="required">*</span></label>
                        <input type="text" id="nombre" name="nombre" class="form-input" placeholder="Ej: Auditorio Principal" required maxlength="100">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="direccion">Dirección <span class="required">*</span></label>
                        <input type="text" id="direccion" name="direccion" class="form-input" placeholder="Ej: Av. Principal 123" required maxlength="150">
                    </div>

                    <div class="form-group">
                        <label class="form-label" for="capacidad">Capacidad <span class="required">*</span></label>
                        <input type="number" id="capacidad" name="capacidad" class="form-input" placeholder="Ej: 150" required min="1" max="10000">
                    </div>
